...
public class ClassPathXmlApplicationContext extends AbstractXmlApplicationContext {
    ...
    public ClassPathXmlApplicationContext(String[] configLocations, boolean refresh, ApplicationContext parent)
        ...
        // 最终会调用AbstractApplicationContext的setParent
        // 如果不是null 会merge ConfigurableEnvironment的环境
        super(parent);
        // （1）将指定的Spring配置文件的路径存储到本地
        // （2）解析Spring配置文件路径中的${PlaceHolder}占位符，
        // 替换为系统变量中PlaceHolder对应的Value值，
        // System本身就自带一些系统变量比如class.path、os.name、user.dir等，
        // 也可以通过System.setProperty()方法设置自己需要的系统变量
        setConfigLocations(configLocations);
        if (refresh) {
            // Spring Bean加载的核心了，父类AbstractApplicationContext的一个方法，
